 ...
 */
export async function genererPdfCr({ cr, affaire, sections, presences, lots, interlocuteurs, zones, photos, liensPhotos, pastilles, plansCr, reglages: brut }) {
  ...
  const definition = definitionPdf({ cr, affaire, sections: choisies, presences, lots, interlocuteurs, zones, reglages, versionPour, images })
